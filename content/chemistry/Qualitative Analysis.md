...
| --------- | -------- | --------------------------------------------------------------------------- | ----- |
| 1         | All ions | $Hg_2Cl_2(s)$, $AgCl(s)$, $PbCl_2(s)$                                       |       |
| 2         | Empty    | $Mn^{2+}$, $Co^{2+}$, $Fe^{3+}$, $Bi^{3+}$, $Cu^{2+}$, $Al^{3+}$, $Zn^{2+}$ |       |
...
| Test Tube | Before                                | After                    | Notes   |
| --------- | ------------------------------------- | ------------------------ | ------- |
| 1         | $Hg_2Cl_2(s)$, $AgCl(s)$, $PbCl_2(s)$ | $Hg_2Cl_2(s)$, $AgCl(s)$ |         |
| Container | Empty                                 | $PbSO_4(s)$              | Dispose |
...
| Test Tube | Before                   | After                  | Notes   |
| --------- | ------------------------ | ---------------------- | ------- |
| 1         | $Hg_2Cl_2(s)$, $AgCl(s)$ | $Hg(l)$, $HgNH_2Cl(s)$ | Dispose |
| 3         | Empty                    | $Ag(NH_3)_2^+$         |         |
...
| Test Tube | Before                                                                      | After                                                               | Notes |
| --------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------- | ----- |
| 2         | $Mn^{2+}$, $Co^{2+}$, $Fe^{3+}$, $Bi^{3+}$, $Cu^{2+}$, $Al^{3+}$, $Zn^{2+}$ | $MnO_2$, $Co(OH)_3(s)$, $Fe(OH)_3(s)$, $Bi(OH)_3(s)$, $Cu(OH)_2(s)$ |       |
| 4         | Empty                                                                       | $Al(OH)_4^-$, $Zn(OH)_4^{2-}$                                       |       |
...
| Test Tube | Before                | After                           | Notes |
| --------- | --------------------- | ------------------------------- | ----- |
| 2         | Assorted Precipitates | $MnO_2$, $Co(OH)_3$             |       |
| 5         | Empty                 | $Fe^{3+}$, $Cu^{2+}$, $Bi^{3+}$ |       |
...
| Test Tube | Before               | After                               | Notes   |
| --------- | -------------------- | ----------------------------------- | ------- |
| 6         | $Mn^{2+}$, $Co^{2+}$ | $K_3\[Co(NO_2)_6\](s)$, assorted ions | Dispose |
...
| Test Tube | Before                          | After                                    | Notes   |
| --------- | ------------------------------- | ---------------------------------------- | ------- |
| 5         | $Fe^{3+}$, $Cu^{2+}$, $Bi^{3+}$ | $Fe(OH)_3(s)$, $Bi(OH)_3(s)$             |         |
| Container | Empty                           | $Cu(NH_3)_4^{2+}$, $Cu_2\[Fe(CN)_6\](s)$ | Dispose |
...
| Test Tube | Before                       | After                       | Notes   |
| --------- | ---------------------------- | --------------------------- | ------- |
| 5         | $Fe(OH)_3(s)$, $Bi(OH)_3(s)$ | $FeSCN^{2+}$, assorted ions | Dispose |
| 7         | Empty                        | $Bi^{3+}$, $Fe^{3+}$        |         |
...
| Test Tube | Before               | After                  | Notes   |
| --------- | -------------------- | ---------------------- | ------- |
| 7         | $Bi^{3+}$, $Fe^{3+}$ | $Bi(s)$, assorted ions | Dispose |
| Container | Empty                | $BiOCl(s)$             | Dispose |
...
- **if a black precipitate forms, bismuth is present**
- dispose of contents in <u>container</u> and <u>Tube 7</u>
### 13. Separation of Zinc and Aluminum
| Test Tube | Before                        | After                 | Notes |
| --------- | ----------------------------- | --------------------- | ----- |
| 4         | $Al(OH)_4^-$, $Zn(OH)_4^{2-}$ | $Al(OH)_3(s)$         |       |
| 8         | Empty                         | $Zn(NH_3)_4^{2+}(aq)$ |       |
...
| Test Tube | Before        | After             | Notes   |
| --------- | ------------- | ----------------- | ------- |
| 4         | $Al(OH)_3(s)$ | red $Al(OH)_3(s)$ | Dispose |
...
| Test Tube | Before                | After                      | Notes   |
| --------- | --------------------- | -------------------------- | ------- |
| 8         | $Zn(NH_3)_4^{2+}(aq)$ | $K_2Zn_3\[Fe(CN)_6\]_2(s)$ | Dispose |
